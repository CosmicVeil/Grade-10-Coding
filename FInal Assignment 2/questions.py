...
challenge_text = ["""You are stuck in a cell. 
                ...
                Each portrait consists of a number or a symbol, and it continues throughout the hallway. Y
                ou decide to document the characters until the end of the hallway, where you are met by a big bulky guard. 
                However, the guard thinks you are guests, and asks you for the password. 
                After some prodding by Loki, the guard answers that the code is a number.

                
                You look back at the letters and see:

                5/(7-4)**2*(11-2).

                What is the password?""", """As you continue your journey through the futuristic facility, 
...
What is the value of m which is printed out: 
