...
explanation_dict = {"2x + 8 = 6": "\n 2x=-2\n x=-1",
    ...
    "5x = 10":"x=10/2\nx=5",
    "Find the sum of the two proots. x^2 + 5x + 6 = 0": "\n(x+3)(x+2)\n\tx=-2,-3\nSo, the sum is: -2+(-3) = -5",
    "Find the sum of the two proots. x^2 + 6x + 5 = 0": "\n(x+5)(x+1)\n\tx=-1,-5\nSo, the sum is: -1+(-1) = -6",
    "Find the sum of the two proots. x^2 - 12x + 16 = 0": "\n(x-8)(x-4)\n\tx=4,8\nSo, the sum is: 4+8 = 12",
    "Find the sum of the two proots. 3x^2 + 16x + 20 = 0": "\n(3x+10)(x+2)\n\tx=-10/3,-2\nSo, the sum is: -2+(-10/3) = -16/3",
    "Find the sum of the two proots. 5x^2 - 23x + 12 = 0": "\n(5x-3)(x-4)\n\tx=4,3/5\nSo, the sum is: 4+(3/5) = 23/5",
    "Find the sum of the two proots. x^2 - 3x - 4 = 0": "\n(x-4)(x+1)\n\tx=4,-1\nSo, the sum is: 4+(-1) = -3",
    "Find the sum of the two proots. 2x^2 + 8x + 6 = 0": "\n2(x+3)(x+1)\n\tx=-3,-1\nSo, the sum is: -3+(-1) = -4",
    "Find the sum of the two proots. x^2 - 5x + 6 = 0": "\n(x-3)(x-2)\n\tx=2,3\nSo, the sum is: 2+3 = 5",
    "Find the sum of the two proots. 3x^2 - 6x - 9 = 0": "\n3(x-3)(x+1)\n\tx=3,-1\nSo, the sum is: 3+(-1) = 2",
    "Find the sum of the two proots. x^2 + 2x - 8 = 0": "\n(x+4)(x-2)\n\tx=-4,2\nSo, the sum is: -4+2 = -2",
    "Find the sum of the two proots. x^2 - 7x + 12 = 0": "\n(x-3)(x-4)\n\tx=3,4\nSo, the sum is: 3+4 = 7",
    "Find the sum of the two proots. 4x^2 + 16x + 15 = 0": "\n(x+3)(x+2)\n\tx=-2,-3\nSo, the sum is: -2+(-3) = -5",
    "Find the sum of the two proots. x^2 - 8x + 15 = 0": "\n(x-5)(x-3)\n\tx=5,3\nSo, the sum is: 5+3 = 8",
    "Find the sum of the two proots. 5x^2 + 5x - 30 = 0": "\n5(x+6)(x-5)\n\tx=-6,5\nSo, the sum is: -6+5 = -1",
    "Find the sum of the two proots. 2x^2 - 12x + 16 = 0": "\n2(x-4)(x-2)\n\tx=2,4\nSo, the sum is: 2+4 = 6", 
    "(1+2)*3": "\n=(3)*3\n=9", 
    "(2+4)/2+6": "\n=(6)/2+6\n=3+6\n=9", 
    "(10+10)/10+10": "\n=(20)/10+10\n=2+10\n=12", 
    "4*4*4/2": "\n=64/2\n=32", 
...
solution_dict = {
    "Find the sum of the two proots. x^2 + 5x + 6 = 0": "-5",
    "Find the sum of the two proots. x^2 + 6x + 5 = 0": "-6",
    "Find the sum of the two proots. x^2 - 12x + 16 = 0": "6",
    "Find the sum of the two proots. 3x^2 + 16x + 20 = 0": "-16/3",
    "Find the sum of the two proots. 5x^2 - 23x + 12 = 0": "23/5",
    "Find the sum of the two proots. x^2 - 3x - 4 = 0": "3",
    "Find the sum of the two proots. 2x^2 + 8x + 6 = 0": "-4",
    "Find the sum of the two proots. x^2 - 5x + 6 = 0": "5",
    "Find the sum of the two proots. 3x^2 - 6x - 9 = 0": "2",
    "Find the sum of the two proots. x^2 + 2x - 8 = 0": "-2",
    "Find the sum of the two proots. x^2 - 7x + 12 = 0": "7",
    "Find the sum of the two proots. 4x^2 + 16x + 15 = 0": "-4",
    "Find the sum of the two proots. x^2 - 8x + 15 = 0": "-8",
    "Find the sum of the two proots. 5x^2 + 5x - 30 = 0": "-1",
    "Find the sum of the two proots. x^2 + 6x + 5 = 0": "-6", 
    "Find the sum of the two proots. 2x^2 - 12x + 16 = 0": "6", 
    "Find the sum of the two proots. 3x^2 + 16x + 20 = 0": "-16/3", 
    "Find the sum of the two proots. 5x^2 - 23x + 12 = 0": "17/5",
    "2x + 8 = 6": "x=-1",
    "3x + 2 = 5x + 6": "x=-2",
    "x + 3x + 4x = 1 + 3 + 4": "x=1",
    "3x + 2x + 8 = -2": "x=-2",
...
quadratics = ["Find the sum of the two proots. x^2 + 5x + 6 = 0", "Find the sum of the two proots. x^2 + 6x + 5 = 0", "Find the sum of the two proots. 2x^2 - 12x + 16 = 0", "Find the sum of the two proots. 3x^2 + 16x + 20 = 0", "Find the sum of the two proots. 5x^2 - 23x + 12 = 0", "Find the sum of the two proots. x^2 + 6x + 5 = 0",
    "Find the sum of the two proots. x^2 - 3x - 4 = 0",
    "Find the sum of the two proots. 2x^2 + 8x + 6 = 0",
    "Find the sum of the two proots. x^2 - 5x + 6 = 0",
    "Find the sum of the two proots. 3x^2 - 6x - 9 = 0",
...
class PracticeMode:
    ...
    def __init__(self):
        ...
        self.option_menu = OptionMenu(self.root, self.operation_var, *self.operations)
        self.option_menu.pack()


        self.start = True

        self.score_label = Label(self.root, text = f"Your score is: 0%")
        self.score_label.pack(anchor="ne")

        # Question label
        self.question_label = Label(self.root, text="Click 'Generate Question' to start.", font=("Arial", 14))
        ...
        # Buttons
        self.generate_button = Button(self.root, text="Generate Question", command=self.generate_question)
        self.generate_button.pack()

        self.check_button = Button(self.root, text="Check Answer", command=self.check_answer)
        ...
        self.current_answer = self.generate_question()
    ...
    def generate_question(self):
        ...
        if self.answer_entry.get() == "" and not self.start:
    ...
    def check_answer(self):
        ...
        solution = self.answer_entry.get()
        answer_print = ""
