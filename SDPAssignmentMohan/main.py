...
class ShowInfo:
    def __init__(self, root):
        ...
        # Quit button
        self.quit_button = Button(frame, text="Quit", command=main.destroy, height=7, width=10)
...
# Add a main frame with a consistent background color
...
# Creates the 3 buttons for each mode, and packs them
