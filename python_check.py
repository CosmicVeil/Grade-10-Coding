# Name: Mohan, Shawn, Cameron
# Date: Feb 29th
# Purpose: Give riddles to people
...
def choose_string_riddle():
    ...
    if answer.strip() == riddle_answer[riddle_num]:
        print("You're correct!")
    else:
        print("Incorrect!")
        print(f"The correct answer was {riddle_answer[riddle_num]}")
...
def choose_math_riddle():
    ...
    if answer == math_riddle_answer[riddle_num]:
        ...
        print("Incorrect!")
        print(f"The correct answer was {math_riddle_answer[riddle_num]}")
